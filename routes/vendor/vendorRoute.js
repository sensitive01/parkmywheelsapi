...
vendorRoute.get("/getbookingdata/:id/:vehicleType/onparking", bookingController.getOnParkingBookingsByVehicleType);
vendorRoute.get("/getbookingdata/:id/:vehicleType/completed", bookingController.getCompletedBookingsByVehicleType);
...
vendorRoute.get("/fast-exit-data/:bookingId", bookingController.fastExitData);
...
vendorRoute.get("/fast-manage/:vendorId", bookingController.fastManageBookings);
vendorRoute.get("/fast-subscriptions/:vendorId", bookingController.fastSubscriptionBookings);
...
vendorRoute.put("/bulk-update-charges", chargesController.bulkAddVendorAmount);
