...
// V2 Optimized Functions
const getBookingSummaryV2 = async (req, res) => {
  try {
    const count = await Booking.countDocuments();
...
const getUserSummaryV2 = async (req, res) => {
  try {
    const count = await userModel.countDocuments();
...
const getVendorSpaceSummaryV2 = async (req, res) => {
  try {
...
const getTransactionSummaryV2 = async (req, res) => {
  try {
    const now = new Date();
    const currentMonth = now.getMonth(); // 0-11
    const currentYear = now.getFullYear();
...
module.exports = {
  getBookingSummaryV2,
  getUserSummaryV2,
  getVendorSpaceSummaryV2,
  getKycSummaryV2,
  getTransactionSummaryV2,
  getAllVendorData,
